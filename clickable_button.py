...
class ClickableButton:
    ...
    def __init__(
        ...
        self.icon = pg.image.load(str(os.path.dirname(__file__)) + '/' + str(display_icon_path))
    ...
    def updater(self):
        ...
        self.button_surface.blit(self.icon, (
            (self.rect.width - self.icon.get_rect().width) / 2,
            (self.rect.height - self.icon.get_rect().height) / 2))
